    ...
    <>
      ...
      <div className="flex flex-wrap items-center justify-center gap-2">
        <button
          id="dial-btn"
          onClick={handleClick}
          className="inline-flex h-12 w-32 items-center justify-center gap-x-2 rounded-full border border-accent-2 bg-accent-2 px-6 py-2 text-center font-medium text-white transition hover:border-[#f4b610] hover:bg-[#f4b610] hover:text-white focus:outline-none focus:ring focus:ring-primary/20 disabled:pointer-events-none disabled:opacity-50 md:px-10 md:text-lg"
        >
          {!loader ? (
            <span className="btn-text"> {!clicked ? "Dial" : "Process"}</span>
          ) : (
            <svg
              id="loader"
