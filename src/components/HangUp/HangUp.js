          ...
          <div className='mt-6 flex h-full flex-col justify-between gap-4'>
            <div className='h-full max-h-[450px] overflow-y-auto overflow-x-hidden rounded-2xl bg-white/30 p-6 md:p-10 [&::-webkit-scrollbar-thumb]:bg-secondary/80 [&::-webkit-scrollbar-track]:bg-secondary/20 [&::-webkit-scrollbar]:w-2'>
              <div className='h-full min-h-[200px] overflow-hidden'>
                ...
                <div className='relative z-10 mt-4 py-10 lg:mt-8'>
                  <h2 className='mt-4 text-center text-2xl font-semibold md:text-3xl'>
                  ...
                  <div className='absolute inset-0 -z-10 grid place-content-center'>
                    <div className='relative h-48 w-48'>
                      <img
                        ...
                        alt=''
                        className='pointer-events-none absolute left-1/2 top-1/2 block h-6 w-6 -translate-x-1/2 -translate-y-1/2 animate-confetti-1 select-none'
                      />
                      <img
                        src='/assets/img/clapping-hand.svg'
                        alt=''
                        className='pointer-events-none absolute left-1/2 top-1/2 block h-6 w-6 -translate-x-1/2 -translate-y-1/2 animate-confetti-2 select-none'
                      />
                      <img
                        src='/assets/img/like.svg'
                        alt=''
                        className='pointer-events-none absolute left-1/2 top-1/2 block h-6 w-6 -translate-x-1/2 -translate-y-1/2 animate-confetti-3 select-none'
                      />
                      <img
                        src='/assets/img/smile.svg'
                        alt=''
                        className='pointer-events-none absolute left-1/2 top-1/2 block h-6 w-6 -translate-x-1/2 -translate-y-1/2 animate-confetti-4 select-none'
                      />
                      <img
                        src='/assets/img/smile.svg'
                        alt=''
                        className='pointer-events-none absolute left-1/2 top-1/2 block h-6 w-6 -translate-x-1/2 -translate-y-1/2 animate-confetti-5 select-none'
                      />
                      <img
                        src='/assets/img/like.svg'
                        alt=''
                        className='pointer-events-none absolute left-1/2 top-1/2 block h-6 w-6 -translate-x-1/2 -translate-y-1/2 animate-confetti-6 select-none'
                      />
                    </div>
                  </div>
                </div>
            ...
            <div className='flex flex-wrap items-center justify-between gap-2'>
              <a
                href='/call-options'
                className='inline-flex items-center gap-x-2 text-gray-800 transition hover:text-secondary'
              >
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='none'
